...
export class CreateWidgetDialogComponent implements OnInit {
  ...
  public readonly dataSource: Array<ICreateWidgetDialogEntry> = [
    ...
    { informationCategory: 'Severity of Pandemic', informationType: CovidInformationType.CovidHospitalCapacity, informationTypeDesc: 'Covid Hospital Capacity', informationSubType: CovidInformationSubType.AmmountOfCapacityUsed, informationSubTypeDesc: 'Ammount of capacity used', type: DashboardWidgetType.BarChart, typeDesc: 'Bar Chart' },
  ];
